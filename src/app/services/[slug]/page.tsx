...
import { services, testimonials, caseStudies, awards, faqs, coManagedFaqs, helpDeskTestimonials, coManagedTestimonials, helpDeskFaqs, securityTestimonials, securityFaqs, azureFaqs } from "@/lib/data";
import { PlaceHolderImages } from "@/lib/placeholder-images";
import { Button } from "@/components/ui/button";
import Link from "next/link";
import { Star, CheckCircle, Lock, Headset, Cloud, ShieldAlert, Briefcase, Bot, Users, Network, Database, Settings, RefreshCw, Lightbulb, Ticket, Tv, MonitorPlay, HeartHand, FileText, LocateFixed, GitBranch, Target, Search, Eye, BarChart, HardHat, LandPlot, Video } from "lucide-react";
...
export default function ServicePage({ params }: { params: { slug: string } }) {
  ...
  if (params.slug === 'it-consulting' || params.slug === 'vcio-consulting' || params.slug === 'data-backup') {
