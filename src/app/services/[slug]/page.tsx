...
import { Star, CheckCircle, Lock, Headset, Cloud, ShieldAlert, Briefcase, Bot, Users, Network, Database, Settings, RefreshCw, Lightbulb, Ticket, Tv, MonitorPlay, HeartHand, FileText, LocateFixed, GitBranch, Target, Search, Eye, BarChart, HardHat, LandPlot } from "lucide-react";
...
export default function ServicePage({ params }: { params: { slug: string } }) {
  ...
  if (params.slug === 'it-consulting' || params.slug === 'cloud-services' || params.slug === 'vcio-consulting' || params.slug === 'data-backup') {
