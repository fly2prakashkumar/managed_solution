...
import { services, testimonials, caseStudies, awards, faqs, coManagedFaqs, coManagedTestimonials } from "@/lib/data";
                    ...
                    <div className="mt-12 grid md:grid-cols-2 gap-8">
                        <Card>
                            <CardHeader>
                                ...
                                <p className="text-muted-foreground">A Collaborative Partnership: Your internal IT team works alongside the external provider.</p>
                            </CardHeader>
                         ...
                         <Card>
                            <CardHeader>
                                ...
                                <p className="text-muted-foreground">Full Outsourcing: The external provider takes full responsibility for your IT operations.</p>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                ...
                                <p><strong>Expertise:</strong> Benefit from the provider's extensive knowledge and experience in managing IT systems.</p>
                            </CardContent>
                        </Card>
                    </div>
                </div>
