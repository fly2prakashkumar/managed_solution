...
export default function EventsPage() {
    return (
        <>
            <PageHeader 
                title="Events"
                description="Stay up to date with our virtual and in-person events to access expert and community intel, as well as resources for your business and technology needs."
            />
                                    ...
                                    <Link href={`/resources/${video.slug}`} className="block">
                                        {videoImage && (
                                            <div className="relative h-56 w-full">
                                                ...
                                                />
                                                <Badge className="absolute top-3 right-3 bg-blue-500 text-white">ON-DEMAND</Badge>
                                            </div>
                                        )}
                                    </Link>
                                    <CardHeader>
